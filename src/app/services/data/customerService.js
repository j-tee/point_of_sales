...
const CustomerService = {
  getCustomerList: (stockId) => axios.get(`${API_URL}api/v1/customers/getCustomerList/${stockId}`, authHeader()),
  ...
  getCustomerDetails: (storeId, page, perPage) => axios.get(`${API_URL}api/v1/customers/getCustomerDetails/${storeId}/${page}/${perPage}`, authHeader()),
};
